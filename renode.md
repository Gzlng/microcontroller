# 1. Установка и первый запуск Renode
1.1 Зайти на https://renode.io/#downloads и скачать эмулятор
    
* Установть эмулятор (требуются права администратора)

1.2 Базовый рабочий процесс (на примере STM32)
...
# 3. Установка на эмулируемый контроллер
В Renode:
